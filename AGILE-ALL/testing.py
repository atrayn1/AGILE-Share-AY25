...
def start_visualization_timed(csv_file, min_time_together, max_time_diff, radius):
    """
...
# Start visualization
start_visualization_timed(csv_file, min_time_together, max_time_diff, radius)
query = (51.05, 0.0)
min_point = (51.0, -0.5)
max_point = (51.1, 0.5)
width_meters = 1000
