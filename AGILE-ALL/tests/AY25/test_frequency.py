...
def test_no_overlap():
    ...
    assert frequencyOfColocation(periods1, periods2, 60) == 0
...
def test_full_overlap():
    ...
    assert frequencyOfColocation(periods1, periods2, 60) == 1
...
def test_partial_overlap():
    ...
    assert frequencyOfColocation(periods1, periods2, 600) == 1  # 10 min (600 sec) overlap
...
def test_multiple_overlaps():
    ...
    assert frequencyOfColocation(periods1, periods2, 300) == 2  # Both overlaps are at least 5 min (300 sec)
...
def test_borderline_overlap():
    ...
    assert frequencyOfColocation(periods1, periods2, 300) == 1  # 5 min (300 sec) overlap
...
def test_no_colocation_due_to_threshold():
    ...
    assert frequencyOfColocation(periods1, periods2, 180) == 0  # Only 2 min overlap, below threshold
...
def test_identical_periods():
    ...
    assert frequencyOfColocation(periods1, periods2, 1800) == 1  # Full 30 min overlap
