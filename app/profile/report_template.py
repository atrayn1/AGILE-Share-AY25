...
class FooterCanvas(canvas.Canvas):
    ...
    def draw_canvas(self, page_count):
        ...
        self.drawImage("../images/logo.png", self.width-inch*8-5, self.height-50, width=100, height=20, preserveAspectRatio=True)
        self.drawImage("../images/logo.png", self.width - inch * 2, self.height-50, width=100, height=30, preserveAspectRatio=True, mask='auto')
...
class PDFPSReport:
    ...
    def firstPage(self):
        ...
        psDetalle = ParagraphStyle('Resumen', fontSize=9, leading=14, justifyBreaks=1, alignment=TA_CENTER, justifyLastLine=1)
        text = """Report Generated by A.G.I.L.E"""
